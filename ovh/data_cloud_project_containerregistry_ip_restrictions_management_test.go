		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"data.ovh_cloud_project_containerregistry_ip_restrictions.mgt-iprestrictions-data", "ip_restrictions.0.ip_block", "121.121.121.121/32"),
					resource.TestCheckResourceAttr(
						"data.ovh_cloud_project_containerregistry_ip_restrictions.mgt-iprestrictions-data", "ip_restrictions.0.description", "my new awesome ip"),
					resource.TestCheckResourceAttrSet(
						"data.ovh_cloud_project_containerregistry_ip_restrictions.mgt-iprestrictions-data", "ip_restrictions.0.created_at"),
				),
			},
		},
	})
